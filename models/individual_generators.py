...
def run_generator(file_path_dict, chem, model_hyperparams, wandb_kwargs, sorted_chem_names, generator_path, notebook_name):
...
notebook_name = '/home/cmdunham/ChemicalDataGeneration/models/ims_generator.py'
...
for chem in sorted_chem_names:
    ...
    if chem != 'JP8': # or chem == 'MES':
        run_generator(file_path_dict, chem, model_hyperparams, wandb_kwargs, sorted_chem_names, generator_path, notebook_name)
#%%
# device = f.set_up_gpu()
