...
#%%
file_path = '../../data/name_smiles_embedding_file_formatted.csv'
name_smiles_embedding_df = pd.read_csv(file_path)
#%%
file_path = '../../data/name_smiles_embedding_file.csv'
name_smiles_embedding_df = pd.read_csv(file_path)
# name_smiles_embedding_df = f.format_embedding_df(name_smiles_embedding_df)
...
best_hyperparams = f.train_model(
    ...
    show_wandb_run_name=True, lr_scheduler=True, class_weights=class_weights
    )
#%%